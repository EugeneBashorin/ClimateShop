...
namespace ClimateStore.UnitTests
{
    ...
    public class AdminTests
    {
        ...
        //получаем ли мы правильный товар
        [TestMethod]
        ...
        //не получаем товара вообще, когда предоставляем недействительное значение ID
        [TestMethod]
        ...
        public void Can_Save_Valid_Changes()
        {
            ...
            ActionResult result = target.Edit(product,null);//null for img load
